...
public class DataSource implements Serializable {
    ...
    public DataSource(Long id, String name, String displayName, String issue, String result, String figure, Date publishTime, String nextissue, Date nexttime, Integer categoryId, String missed, Date currenttime, Date createtime) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNextissue() == null ? other.getNextissue() == null : this.getNextissue().equals(other.getNextissue()))
